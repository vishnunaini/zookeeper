% zookeeper(SECTION) | User Commands
%
% "March 26 2022"
...
zookeeper - program to do something

# SYNOPSIS

**zookeeper** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**zookeeper** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **zookeeper** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**zookeeper** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    zookeeper. See **foo.conf**(5) for further details.
...
**zookeeper** provides some return codes, that can be used in scripts:
...
vishnunaini <vishnu@vishnunaini.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 vishnunaini
